        ...
        languageIndex.getModel().addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                switch((int)(languageIndex.getValue())){
                    ...
                    case 1:
                        languageLabel.setText("Momentan ist der Handlungsbogen, um Dr. Emmett L. „Doc“ Brown, der seinen Hund in dr Zukunft sucht"); break;
                    case 2:
                        languageLabel.setText("Momentan ist der kontextfreie Parser ausgewählt"); break;
