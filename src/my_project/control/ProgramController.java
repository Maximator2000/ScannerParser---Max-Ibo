...
import my_project.model.KontextfreierParser;
import my_project.model.TimeParser;
...
public class ProgramController {
    ...
    private KontextfreierParser kontextfreierParser;
    ...
    public void startProgram() {
        ...
        kontextfreierParser=new KontextfreierParser();
    ...
    public boolean parseString(String input, int parserIndex){
        switch(parserIndex){
            ...
            case 2:
                return kontextfreierParser.parse(input);
    ...
    public boolean scanString(String input, int parserIndex){
        switch(parserIndex){
            ...
            case 1:
                boolean res=timeParser.getScannerResult(input);
                System.out.println("TimeScanner DEBUG - "+timeParser.getScannerOutput());
                return res;
            case 2:
                boolean rückgabe=kontextfreierParser.getScannerResult(input);
                System.out.println("TimeScanner DEBUG - "+kontextfreierParser.getScannerOutput());
                return rückgabe;
